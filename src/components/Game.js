  ...
  return (
    <div className="game-container">
      ...
      <div className="scoring-pattern">
        <p><strong>Cooperate, Cooperate:</strong> 1,1 (Each serves 1 year) </p>
        <p><strong>Cooperate, Defect:</strong> 3, 0 
        (Prisoner A: 3 years while Prisoner B: goes free )</p>
        <p><strong>Defect, Cooperate:</strong> 0,3 (Prisoner A: goes free while Prisoner B: 3 years)</p>
        <p><strong>Defect, Defect:</strong> 2,2 (Each serves 2 years)</p>
      </div>
